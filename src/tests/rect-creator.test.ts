...
describe('test rect-creator methods', () => {
    ...
    test('get start point function', () => {
        ...
        expect(rectCR1.checkIfPointBelongsToLine(line1, '3-1').length).toBe(3)
        expect(rectCR1.checkIfPointsBelongToSameLine('1-1', '3-1', 'blue').length).toBe(3)
        expect(rectCR1.checkIfPointBelongsToLine(line1, '3-1', '1-1').length).toBe(3)
        ...
        // expect(rectCR0.checkIfLineHasCircle('0-0', 'blue').length).toBe(0)
        // expect(rectCR1.checkIfLineHasCircle('1-2', 'blue').length).toBe(9)
