...
export const CreatorManagerMenu: React.FC = () => {
    const [resolveCreated, setResolveCreated] = useState(puzzlesManager.newlyCreatedChecked)
    const [autoResolving, setAutoResolving] = useState(pC.autoResolving)

    useEffect(() => {
        return pC.$autoResolving.subscribe(setAutoResolving)
    })

    // const handleAutoResolving = () => {
    //     if(!Object.keys(pC.lineEndpoints).length) return
    //     setAutoResolving(!autoResolving)
    //     pC.handleAutoResolvePuzzle()
    // }

    const handleResolveCreated = () => {
        console.log('handle resolve menu', resolveCreated)
        if(!pC.puzzle.points) return
        puzzlesManager.switchToResolverView()
    ...
    const handleClearAll = () => {
        clearAll()
        puzzlesManager.newlyCreatedChecked && puzzlesManager.checkNewlyCreated()
        puzzlesManager.switchToResolverView(false)
    }
    ...
    const sharePuzzle = () => {
        ...
        // if (valid !== 'valid') {
        //     // TODO resolve errors // almost done
        //     console.error(valid)
        //     return
        // }
    ...
    return (
        <div className='dots-puzzle_menu__footer'>
            ...
            <button
                type="button"
                className='dots-puzzle_menu__btn auto-resolve'
...
export const PuzzleColorsMenu: React.FC<ICustomPuzzle> =
    (props: ICustomPuzzle) => {
    const {
        color,
        handlers: {
